...
Machine learning and big data are really the future of data science. There are tons of tutorials and courses about this. Here are what I find:

* [10 popular machine learning algorithms](http://vitalflux.com/cheat-sheet-10-machine-learning-algorithms-r-commands/)

* [20 short tutorials all data scientists should read](http://www.datasciencecentral.com/profiles/blogs/17-short-tutorials-all-data-scientists-should-read-and-practice)
